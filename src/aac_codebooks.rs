//! AAC Huffman codebook data and scalefactor band offset tables.

// ---------------------------------------------------------------------------
// Spectral Codebook 1 (81 entries, 4-tuple, signed, mod 3)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB1_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB1_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 2 (81 entries, 4-tuple, signed, mod 3)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB2_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB2_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 3 (81 entries, 4-tuple, unsigned, mod 3)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB3_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB3_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 4 (81 entries, 4-tuple, unsigned, mod 3)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB4_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB4_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 5 (81 entries, 2-tuple, signed, mod 9)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB5_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB5_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 6 (81 entries, 2-tuple, signed, mod 9)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB6_LENS: [u8; 81] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB6_CODES: [u32; 81] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 7 (64 entries, 2-tuple, unsigned, mod 8)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB7_LENS: [u8; 64] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB7_CODES: [u32; 64] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 8 (64 entries, 2-tuple, unsigned, mod 8)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB8_LENS: [u8; 64] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB8_CODES: [u32; 64] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 9 (169 entries, 2-tuple, unsigned, mod 13)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB9_LENS: [u8; 169] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB9_CODES: [u32; 169] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 10 (169 entries, 2-tuple, unsigned, mod 13)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB10_LENS: [u8; 169] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB10_CODES: [u32; 169] = [
...
// ---------------------------------------------------------------------------
// Spectral Codebook 11 (289 entries, 2-tuple, unsigned, mod 17)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SPECTRUM_CB11_LENS: [u8; 289] = [
...
#[rustfmt::skip]
pub(crate) const SPECTRUM_CB11_CODES: [u32; 289] = [
...
// ---------------------------------------------------------------------------
// Scalefactor Codebook (121 entries)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const SCF_CB_LENS: [u8; 121] = [
...
#[rustfmt::skip]
pub(crate) const SCF_CB_CODES: [u32; 121] = [
...
// ---------------------------------------------------------------------------
// Quads lookup table (codebooks 1-4 use 4-tuple indexing)
// ---------------------------------------------------------------------------

#[rustfmt::skip]
pub(crate) const AAC_QUADS: [(u8, u8, u8, u8); 81] = [
...
pub(crate) const SPECTRUM_CODEBOOKS: [CodebookInfo; 11] = [
    CodebookInfo {
        lens: &SPECTRUM_CB1_LENS,
        codes: &SPECTRUM_CB1_CODES,
        dimension: 4,
        is_unsigned: false,
        mod_value: 3,
    },
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_96K_LONG: [usize; 42] = [
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_64K_LONG: [usize; 48] = [
    0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 64,
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_64K_SHORT: [usize; 13] = [
    0, 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 92, 128,
];

#[rustfmt::skip]
pub(crate) const SWB_OFFSET_48K_LONG: [usize; 50] = [
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_48K_SHORT: [usize; 15] = [
    0, 4, 8, 12, 16, 20, 28, 36, 44, 56, 68, 80, 96, 112, 128,
];

#[rustfmt::skip]
pub(crate) const SWB_OFFSET_32K_LONG: [usize; 52] = [
    0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 48, 56, 64, 72, 80,
    88, 96, 108, 120, 132, 144, 160, 176, 196, 216, 240, 264, 292, 320, 352, 384,
    416, 448, 480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864, 896,
    928, 960, 992, 1024,
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_24K_LONG: [usize; 48] = [
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_24K_SHORT: [usize; 16] = [
    0, 4, 8, 12, 16, 20, 24, 28, 36, 44, 52, 64, 76, 92, 108, 128,
];

#[rustfmt::skip]
pub(crate) const SWB_OFFSET_16K_LONG: [usize; 44] = [
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_16K_SHORT: [usize; 16] = [
    0, 4, 8, 12, 16, 20, 24, 28, 32, 40, 48, 60, 72, 88, 108, 128,
];

#[rustfmt::skip]
pub(crate) const SWB_OFFSET_8K_LONG: [usize; 41] = [
...
#[rustfmt::skip]
pub(crate) const SWB_OFFSET_8K_SHORT: [usize; 16] = [
    0, 4, 8, 12, 16, 20, 24, 28, 36, 44, 52, 60, 72, 88, 108, 128,
];

// ---------------------------------------------------------------------------
// SWB offset lookup by sample rate
// ---------------------------------------------------------------------------

pub(crate) fn swb_offsets(sample_rate: u32) -> (&'static [usize], &'static [usize]) {
    if sample_rate >= 75132 {
        (&SWB_OFFSET_96K_LONG, &SWB_OFFSET_64K_SHORT)
    } else if sample_rate >= 55426 {
        (&SWB_OFFSET_64K_LONG, &SWB_OFFSET_64K_SHORT)
    } else if sample_rate >= 37566 {
        (&SWB_OFFSET_48K_LONG, &SWB_OFFSET_48K_SHORT)
    } else if sample_rate >= 27713 {
        (&SWB_OFFSET_32K_LONG, &SWB_OFFSET_48K_SHORT)
    } else if sample_rate >= 18783 {
        (&SWB_OFFSET_24K_LONG, &SWB_OFFSET_24K_SHORT)
    } else if sample_rate >= 9391 {
        (&SWB_OFFSET_16K_LONG, &SWB_OFFSET_16K_SHORT)
    } else {
        (&SWB_OFFSET_8K_LONG, &SWB_OFFSET_8K_SHORT)
    }
}
